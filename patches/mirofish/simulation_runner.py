...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        Returns:
            SimulationRunState
        """
        # PATCH (price-impact): cap the simulation length. When the caller (the
        # frontend) doesn't pass max_rounds, default to OASIS_DEFAULT_MAX_ROUNDS
        # so a long LLM-planned world is truncated instead of running its full
        # duration. Applies to both the round estimate and the run cmd below.
